...
function ItalianTestAppContent() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center bg-[#0a0a0a] text-white selection:bg-[var(--theme-color)] selection:text-white">
      ...
      <CustomDialog
        ...
        description={startFromParam ? `You're about to start the test from ${LEVEL_LABELS[startFromParam]}.` : "You're about to start the elementary Italian test."}
        cancelText="Cancel"
...
export default function ItalianTestApp() {
  return (
    <TooltipProvider>
      <Suspense fallback={null}>
        <ItalianTestAppContent />
      </Suspense>
    </TooltipProvider>
  );
}
