...
export default function ResultRevealCard({
  ...
  const getSubStatusText = () => {
    if (isC2Passed) return "You have demonstrated mastery of Italian at the highest level!";
  ...
  const handleShareOnX = () => {
    ...
    const text = `I've just completed the Italian proficiency test! My assessed level is: ${levelStr}. Find yours at:`;
