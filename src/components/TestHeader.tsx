      ...
      <div className="flex items-center justify-between w-full relative">
        ...
        <div className="flex flex-col items-center justify-center text-center flex-1">
          <div className="text-center">
            ...
            <h1 className="hidden max-[480px]:block max-[480px]:text-[13px] max-[480px]:leading-[1.9] max-[480px]:translate-y-[18px] font-bold text-[var(--foreground)] tracking-tight">
              <div>100% Free Elementary</div>
              <div>Italian Test</div>
            </h1>
